...
void gnss_frame::set_origin(const sensor_msgs::NavSatFixConstPtr& nav_sat_fix_ptr)
{
...
void gnss_frame::set_frame(const sensor_msgs::NavSatFixConstPtr& nav_sat_fix_ptr)
{
